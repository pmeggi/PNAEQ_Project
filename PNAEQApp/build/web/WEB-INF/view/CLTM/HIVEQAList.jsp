...
<div id="indexRightColumn">
    ...
    <table id="eqaTable">
        ...
        <tr class="lightBlue">
            ...
            <td>CREATED</td>
            <td>
                <a href="<c:url value='/register?type=HIV&u=CLTM'/>">
        ...
        <tr class="blue">
            ...
            <td>REJECTED</td>
            <td>
                <a href="<c:url value='/reregister?type=HIV&u=CLTM'/>">
                    <img class="icon" src="img/re-register.png" title="Re-Register Results">
                </a>
            </td>
        </tr>
        <tr class="lightBlue">
            ...
            <td>PUBLISHED</td>
            <td>
                 <a href="<c:url value='/viewResults?type=HIV&u=CLTM'/>">
