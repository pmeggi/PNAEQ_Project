<%-- 
    Document   : MalariaEQAList
    Created on : Oct 9, 2015, 6:01:26 PM
    Author     : Pinki Meggi
--%>
...
<div id="indexRightColumn">
    <h2> LAB 100 - MALARIA Serology Trails</h2>
    <table id="eqaTable">
        <tr class="header">
            <th>No.</th>
            <th>Begin Date</th>
        ...
        <tr class="lightBlue">
            ...
            <td>CREATED</td>
            <td>
                <a href="<c:url value='/register?type=Malaria&u=Supervisor'/>">
        ...
        <tr class="blue">
            ...
            <td>VALIDATED</td>
            <td>
                <a href="<c:url value='/viewResult?type=Malaria&u=Supervisor'/>">
