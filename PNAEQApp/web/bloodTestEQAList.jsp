<%-- 
    Document   : bloodTestEQAList
    Created on : Oct 9, 2015, 2:31:47 PM
    Author     : Pinki Meggi
--%>
...
<div id="indexLeftColumn" class="alignLeft">
    ...
    <div id="menu" class="alignLeft">
        <p><a href="supervisorMenu.jsp">Home</a></p>
    </div>
    <br><br><br><br>
    <div id="menu" class="alignLeft">
        <p><a href="<c:url value='viewCustomers'/>">View all Notifications</a></p>
    </div>
    <br><br><br><br>
    <div id="menu" class="alignLeft">
...
<div id="indexRightColumn">
    <h2> LAB 100 - HIV Serology Trails</h2>
    <table id="eqaTable">
        <tr class="header">
            <th>No.</th>
            <th>Begin Date</th>
